...
commonname=none
email=rizkihdyt6@gmail.com

# simple password minimal
wget -O /etc/pam.d/common-password "${Repo}password.txt"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw ${Repo}badvpn/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service ${Repo}badvpn/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service ${Repo}/badvpn/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service ${Repo}badvpn/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget -q -O /etc/issue.net "${Repo}minacantik/issue.net"
