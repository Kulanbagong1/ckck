...
IZIN=$(curl -sS Repo="https://raw.githubusercontent.com/Kulanbagong1/ckck/main/"
Repo1="https://raw.githubusercontent.com/Kulanbagong1/izinn/main/"
...
CEKEXPIRED () {
    today=$(date -d +1day +%Y-%m-%d)
    Exp1=$(curl -sS https://raw.githubusercontent.com/Kulanbagong1/izinn/main/ip | grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
    echo -e "\e[32mSTATUS SCRIPT AKTIF...\e[0m"
    else
Repo="https://raw.githubusercontent.com/Kulanbagong1/ckck/main/"
...
IZIN=$(curl -sS https://raw.githubusercontent.com/Kulanbagong1/izinn/main/ip | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
wget ${Repo}domain.sh && chmod +x domain.sh && ./domain.sh
sleep 1
#install ssh ovpn
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "${Repo}Menu%20Final/Lain/notramcpu" && chmod +x /usr/bin/notramcpu
...
#xray
wget -q -O ins-xray.sh ${Repo}ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
sleep 1
wget -q -O senmenu.sh ${Repo}senmenu.sh && chmod +x senmenu.sh && ./senmenu.sh
wget -q -O slow.sh ${Repo}slow.sh && chmod +x slow.sh && ./slow.sh
#cronjob
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Nyolong By RizkiHdyt ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "ADIOS"
